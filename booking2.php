...
@media (max-width: 800px) {
  ...
  .col-25 {
    ...
    var time = parseInt(document.getElementById("hours").value)
          ...
          result.value = charge;
          // sessionStorage.setItem("cust_charge", result);
}
...
<div class="rowb">
  <div class="col-75">
    <div class="containerb">
      <form action="booking_insert.php?slt_no=<?php 
      echo $_GET['slotno'] ;
    ?> "
...
<!--             <label for="date"><i class="fa fa-calendar"></i> Date</label>
          ...
          <div class="col-50">
            ...
            <label for="date_in"><i class="fa fa-calendar"></i> Booking Day</label>
            <input type="date" id="currentDate" name="currentDate" placeholder="" required readonly>
            <!-- <label for="date_out"><i class="fa fa-time"></i> Day Out</label> -->
            <!-- <input type="date" id="date_out" name="date_out" placeholder="" required> -->
        ...
        <button type="submit" class="btn" name="submit" value="submit" id="myBtn">Pay Now</button>
