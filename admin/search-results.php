				...
				<div class="col-lg-12">
					<div class="panel panel-default">
                        ...
                        <table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
                            ...
                            <?php
                            $ret=mysqli_query($con,"SELECT * from booking_details where no_plate like '$sdata%'");
                            ...
                            ?>
                                ...
                                <?php if(empty($row['slot_status']== 0)){ ?>
                                    <td><a href="update-incomingdetail.php?updateid=<?php echo $row['bid'];?>"><button type="button" class="btn btn-sm btn-info">Take Action</button></a></td>
                                 <?php } else { echo '<td></td>'; }?>
