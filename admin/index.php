...
<body style="background-image: url('../images/parkallocation.jpeg');width: 100%; height: 50%;">
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
		<center><h2><b></b></h2></center>
			<div class="login-panel panel panel-default">
				<h1 style="font-family: fantasy; color: darkcyan; text-align: center;">NCPS ADMIN PANEL</h1>
