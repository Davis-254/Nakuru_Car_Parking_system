	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
				<div class="col-lg-12">
                    ...
                    <?php
                    $ret=mysqli_query($con,"SELECT * from booking_details where date(book_time) between '$fdate' and '$tdate'");
                    $cnt=1;
                    ...
                    ?>
                        ...
                        <!-- <td><a href="update-incomingdetail.php?updateid=<?php echo $row['bid'];?>"><button type="button" class="btn btn-sm btn-danger">Take Action</button></a>
                        </td> -->
