	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Outgoing Vehicles</li>
			</ol>
		</div><!--/.row-->
        ...
        <?php
        // $cid=$_GET['viewid'];
        $ret=mysqli_query($con,"SELECT * from  booking_details where slot_status='1'");
        $cnt=1;
        ...
        ?>
            ...
            <a href="print-receipt.php?vid=<?php echo $row['bid'];?>"><button type="button" class="btn btn-sm btn-warning"> <i class="fa fa-print"></i></button>
            </td>
